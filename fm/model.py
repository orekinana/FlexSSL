...
from torchvision.models.resnet import model_urls, BasicBlock, Bottleneck, ResNet
...
class ResNetModel(ResNet):
    ...
    def __init__(
            ...
            norm_layer: Optional[Callable[..., torch.nn.Module]] = None) -> None:
        super().__init__(
...
def resnet18(pretrained: bool = False, num_classes=10, progress: bool = True, **kwargs: Any):
    model = ResNetModel(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    if pretrained:
